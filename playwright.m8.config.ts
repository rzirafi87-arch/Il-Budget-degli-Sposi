...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["milestone8-lifecycle.spec.ts", "branch52-location-supplier.spec.ts", "branch52-supplier-work.spec.ts", "branch52-milestone5-ux.spec.ts", "branch52-security-matrix.spec.ts", "branch53-persistence.spec.ts"],
  ...
  projects: [
    ...
    { name: "m8-390", grep: /\[M6\]\[security-matrix\]|\[B53\]\[persistence-mobile\]/, use: { locale: "it", viewport: { width: 390, height: 844 } } },
