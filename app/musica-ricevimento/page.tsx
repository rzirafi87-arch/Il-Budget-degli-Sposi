...
export default function MusicaRicevimentoPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        alert("Musica ricevimento inviata! Sarà verificata prima della pubblicazione.");
        setFormData({
          name: "",
          region: "",
          province: "",
  ...
  return (
    <section className="pt-6">
      <h2 className="font-serif text-3xl mb-6">Musica Ricevimento</h2>

      {/* Carosello immagini */}
      <ImageCarousel images={PAGE_IMAGES["musica-ricevimento"]} height="280px" />

      <p className="text-sm text-gray-600 mb-6">
        Trova DJ, band e intrattenimento musicale verificato per il ricevimento.
        Puoi proporre nuovi artisti che verranno verificati prima della pubblicazione.
      </p>
