...
export default function ContattiPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Implementare invio contatto
    console.log("Form contatto:", formData);
    setSubmitted(true);
    setTimeout(() => {
      setSubmitted(false);
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border-2 border-gray-200">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#A3B59D] to-[#8a9d84] text-white px-6 py-4 rounded-xl font-bold text-lg hover:shadow-xl transition-all active:scale-95"
              >
                📤 Invia Messaggio
              </button>
            </form>
