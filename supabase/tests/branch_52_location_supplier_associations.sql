...
select lives_ok($q$insert into public.event_location_supplier_links(id,event_id,saved_location_id,saved_supplier_id,relationship_type,created_by) values('52300000-0000-4000-8000-000000000080','52300000-0000-4000-8000-000000000010','52300000-0000-4000-8000-000000000040','52300000-0000-4000-8000-000000000050','recommended','52300000-0000-4000-8000-000000000001')$q$,'owner creates saved-location to saved-supplier link');
select lives_ok($q$insert into public.event_location_supplier_links(id,event_id,saved_location_id,private_supplier_id,relationship_type,created_by) values('52300000-0000-4000-8000-000000000081','52300000-0000-4000-8000-000000000010','52300000-0000-4000-8000-000000000040','52300000-0000-4000-8000-000000000061','preferred_supplier','52300000-0000-4000-8000-000000000001')$q$,'owner creates saved-location to private-supplier link');
select lives_ok($q$insert into public.event_location_supplier_links(id,event_id,private_location_id,saved_supplier_id,relationship_type,created_by) values('52300000-0000-4000-8000-000000000082','52300000-0000-4000-8000-000000000010','52300000-0000-4000-8000-000000000060','52300000-0000-4000-8000-000000000050','external_allowed','52300000-0000-4000-8000-000000000001')$q$,'owner creates private-location to saved-supplier link');
select lives_ok($q$insert into public.event_location_supplier_links(id,event_id,private_location_id,private_supplier_id,relationship_type,private_notes,created_by) values('52300000-0000-4000-8000-000000000083','52300000-0000-4000-8000-000000000010','52300000-0000-4000-8000-000000000060','52300000-0000-4000-8000-000000000061','historic_relationship','private note','52300000-0000-4000-8000-000000000001')$q$,'owner creates private-location to private-supplier link');
...
select lives_ok($q$insert into public.event_location_supplier_links(id,event_id,saved_location_id,saved_supplier_id,relationship_type,created_by) values('52300000-0000-4000-8000-000000000084','52300000-0000-4000-8000-000000000010','52300000-0000-4000-8000-000000000040','52300000-0000-4000-8000-000000000050','works_at','52300000-0000-4000-8000-000000000001')$q$,'same pair may have another allowed relationship type');
...
select lives_ok($q$update public.event_location_supplier_links set private_notes='partner update' where id='52300000-0000-4000-8000-000000000080'$q$,'active partner updates private notes');
select lives_ok($q$delete from public.event_location_supplier_links where id='52300000-0000-4000-8000-000000000084'$q$,'active partner deletes a private link');
...
set local role postgres;
select throws_ok($q$update public.event_location_supplier_links set saved_supplier_id=null,private_supplier_id='52300000-0000-4000-8000-000000000061' where id='52300000-0000-4000-8000-000000000080'$q$,'23514',null,'identity trigger blocks endpoint replacement even for service writes');
select is((select private_notes from public.event_location_supplier_links where id='52300000-0000-4000-8000-000000000080'),'partner update','allowed partner update is persisted');
