...
export const EVENT_CONFIGS: Record<EventType, EventConfiguration> = {
  wedding: {
    ...
    timelineTasks: [
      ...
      { title: "Definite budget e stile", description: "Scegliete priorità e moodboard", monthsBefore: 10, category: "Budget", priority: "alta" },
      ...
      { title: "Definite menù e logistica", description: "Tavoli, ospiti e trasporti", monthsBefore: 3, category: "Ricevimento", priority: "media" },
  ...
  baptism: {
    ...
    timelineTasks: [
      { title: "Scegli chiesa e data", description: "Verifica disponibilità del parroco", monthsBefore: 6, category: "Cerimonia", priority: "alta" },
      { title: "Nomina padrino e madrina", description: "Condividi ruolo e responsabilità", monthsBefore: 5, category: "Famiglia", priority: "alta" },
      ...
      { title: "Definisci budget e lista ospiti", description: "Stabilisci priorità con la famiglia", monthsBefore: 3, category: "Budget", priority: "media" },
  ...
  birthday: {
    ...
    timelineTasks: [
      ...
      { title: "Organizza intrattenimento", description: "Playlist, animazione o attività", monthsBefore: 2, category: "Intrattenimento", priority: "media" },
  ...
  "turning-50": {
    ...
    budgetCategories: {
      ...
      "Esperienze": ["Viaggio", "Attività speciali", "Regali charity", "After party"],
  ...
  confirmation: {
    ...
    timelineDescription: "Guida pratica per preparare la cresima con serenità e cura.",
    timelineBuckets: [
      { label: "6 mesi prima", minMonthsBefore: 6, maxMonthsBefore: INFINITY },
      { label: "4-5 mesi prima", minMonthsBefore: 4, maxMonthsBefore: 5 },
      { label: "3 mesi prima", minMonthsBefore: 3, maxMonthsBefore: 3 },
    ...
    timelineTasks: [
      ...
      { title: "Conferma ospiti e menù", description: "Adatta menù a eventuali esigenze", monthsBefore: 1, category: "Ricevimento", priority: "media" },
