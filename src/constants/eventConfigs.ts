...
export const EVENT_CONFIGS: Record<EventType, EventConfiguration> = {
  wedding: {
    ...
    timelineTasks: [
      ...
      { title: "Definite budget e stile", description: "Scegliete priorit+� e moodboard", monthsBefore: 10, category: "Budget", priority: "alta" },
  ...
  baptism: {
    ...
    timelineTasks: [
      { title: "Scegli chiesa e data", description: "Verifica disponibilit+� del parroco", monthsBefore: 6, category: "Cerimonia", priority: "alta" },
      { title: "Nomina padrino e madrina", description: "Condividi ruolo e responsabilit+�", monthsBefore: 5, category: "Famiglia", priority: "alta" },
      ...
      { title: "Definisci budget e lista ospiti", description: "Stabilisci priorit+� con la famiglia", monthsBefore: 3, category: "Budget", priority: "media" },
