...
export const EVENT_CONFIGS: Record<EventType, EventConfiguration> = {
  ...
  birthday: {
    ...
    timelineTasks: [
      ...
      { title: "Organizza intrattenimento", description: "Playlist, animazione o attivit+�", monthsBefore: 2, category: "Intrattenimento", priority: "media" },
  ...
  confirmation: {
    ...
    timelineDescription: "Guida pratica per preparare la cresima con serenit+� e cura.",
    timelineBuckets: [
      { label: "6 mesi prima", minMonthsBefore: 6, maxMonthsBefore: INFINITY },
      { label: "4-5 mesi prima", minMonthsBefore: 4, maxMonthsBefore: 5 },
      { label: "3 mesi prima", minMonthsBefore: 3, maxMonthsBefore: 3 },
