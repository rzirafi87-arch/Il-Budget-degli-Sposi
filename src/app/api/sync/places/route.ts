...
const TYPE_CONFIG = {
  ...
  band: {
    ...
    keywords: ["band matrimonio", "musica matrimonio", "gruppo musicale"],
  },
  dj: {
    includedTypes: [],
  ...
  photographer: {
    ...
    keywords: ["fotografo matrimonio", "wedding photographer"],
  },
  videographer: {
    includedTypes: ["videographer"],
    keywords: ["videomaker matrimonio", "video matrimonio"],
  },
  florist: {
    includedTypes: ["florist"],
    keywords: ["fiorista matrimonio", "addobbi floreali matrimonio"],
  },
  caterer: {
    includedTypes: ["caterer"],
    keywords: ["catering matrimonio", "banchetti"],
  },
};
