...
export default function AuthPage() {
  ...
  async function signUp() {
    ...
    try {
      await request("/api/auth/register", { primaryEmail: email, password, eventType, partnerEmail: partnerEmail || undefined, weddingDate: weddingDate || undefined });
