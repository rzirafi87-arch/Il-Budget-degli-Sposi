...
export default function FotografiPage() {
  const t = useTranslations("suppliersPhotographers");
    ...
    <section className="pt-6">
      ...
      <Breadcrumb
        items={[
          ...
          { label: t("breadcrumb.photographers") },
        ]}
      />
          ...
          {filtered.map((p) => (
            <div key={p.id} className="p-6 rounded-2xl border-2 border-gray-200 bg-white shadow-soft hover:shadow-soft-lg hover:scale-105 transition-all">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                >
                  {isFavorite(p.id) ? t("actions.removeFromFavorites") : t("actions.addToFavorites")}
                </button>
              </div>
            </div>
          ))}
              ...
              <div className="flex justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex gap-4 mt-3 text-xs text-gray-500 flex-wrap">
                    ...
                    {p.website && (
                      <a href={p.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">{t("actions.websiteLink")}</a>
                    )}
                  </div>
                </div>
