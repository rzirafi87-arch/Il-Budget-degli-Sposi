...
const DEMO_EVENTS = [
  { id: "evt-1", name: "Matrimonio Italia", date: "2025-06-15", country: "it" },
  { id: "evt-2", name: "Boda Mexico", date: "2025-12-10", country: "mx" },
  { id: "evt-3", name: "Anniversario", date: "2026-03-20", country: "it" },
];
...
export default function SelectEventPage() {
  ...
  function handleCreate() {
    // Demo: crea nuovo evento
    const newId = `evt-${events.length + 1}`;
    const newEvent = { id: newId, name: `Evento ${newId}`, date: "2026-01-01", country: "it" };
