...
export default function FotografiPage() {
  ...
  params.append("category", "Fotografi");
      ...
      console.error("Errore caricamento fotografi:", e);
      setItems([]);
    } finally {
      setLoading(false);
    }
    ...
    <section className="pt-6">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <h2 className="font-serif text-3xl mb-2">📸 Fotografi</h2>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            Trova i migliori fotografi e videomaker per il tuo matrimonio. Filtra per regione e
            provincia, confronta prezzi e visita i loro portfolio.
          </p>
        </div>
        <Link
          href="/fornitori"
      ...
      <ImageCarousel images={PAGE_IMAGES.fotografi || PAGE_IMAGES.fornitori} height="280px" />

      {/* Filtri */}
      <div className="mb-6 p-6 rounded-2xl border border-gray-200 bg-white/70 shadow-sm">
        <h3 className="font-semibold mb-4">Filtra fotografi</h3>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="Nome studio o fotografo..."
              />
      ...
      <div className="mb-6 flex justify-between items-center">
        <p className="text-sm text-gray-600">
          {filtered.length} {filtered.length === 1 ? "fotografo trovato" : "fotografi trovati"}
        </p>
        <div className="flex gap-2">
          <button
      ...
      {loading ? (
        ...
        <div className="p-10 text-center text-gray-400 rounded-2xl border border-gray-200 bg-white/70">
          ...
          <p className="text-lg font-medium">Nessun fotografo trovato</p>
