  ...
  return (
    <section className="pt-6">
      ...
      <nav className="mb-4 flex items-center gap-2 text-sm text-gray-600">
        ...
        <span>›</span>
        <span className="text-gray-900 font-medium">Catering</span>
      </nav>

      {/* Header con bottone Torna a Fornitori */}
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <h2 className="font-serif text-3xl mb-2">🍽️ Catering & Banqueting</h2>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            Trova i migliori servizi di catering per il tuo matrimonio. Menù personalizzati, buffet gourmet e servizio impeccabile.
          </p>
        </div>
        <Link
          href="/fornitori"
      ...
      <ImageCarousel images={PAGE_IMAGES.catering || PAGE_IMAGES.location} height="280px" />

      {/* Filtri */}
      <div className="mb-6 p-6 rounded-2xl border border-gray-200 bg-white/70 shadow-sm">
        <h3 className="font-semibold mb-4">Filtra servizi catering</h3>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="Nome location o catering..."
              />
      ...
      <div className="mb-6 flex justify-between items-center">
        <p className="text-sm text-gray-600">
          {filtered.length} {filtered.length === 1 ? "servizio catering trovato" : "servizi catering trovati"}
        </p>
        <div className="flex gap-2">
          <button
      ...
      {loading ? (
        ...
        <div className="p-10 text-center text-gray-400 rounded-2xl border border-gray-200 bg-white/70">
          ...
          <p className="text-lg font-medium">Nessun servizio catering trovato</p>
