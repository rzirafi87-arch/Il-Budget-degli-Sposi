...
export default async function PublicLanding({ locale }: { locale: Locale }) {
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[#f8f5f0] text-fg">
      ...
      <main id="contenuto">
        ...
        <section id="funzionalita" className="scroll-mt-24 bg-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
        ...
        <section id="vantaggi" className="scroll-mt-24 bg-[#eaf0eb] px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="grid gap-4">{[WalletCards, HeartHandshake, ShieldCheck].map((Icon, index) => <div key={index} className="flex gap-4 rounded-2xl border border-primary/10 bg-white p-5 shadow-soft-sm sm:p-6"><span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary"><Icon size={22} aria-hidden /></span><div><h3 className="text-lg text-fg">{t(`benefits.items.${index}.title`)}</h3><p className="mt-1 text-sm leading-6 text-muted-fg">{t(`benefits.items.${index}.description`)}</p></div></div>)}</div>
          </div>
        </section>

        <section id="faq" className="scroll-mt-24 bg-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <SectionIntro eyebrow="FAQ" title={t("faq.title")} description={t("faq.description")} />
          <div className="mx-auto mt-12 max-w-3xl divide-y divide-border overflow-hidden rounded-3xl border border-border bg-white shadow-soft-sm">
        ...
        <section className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8"><div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-primary px-6 py-12 text-center shadow-soft-xl sm:px-12 sm:py-16"><Sparkles className="mx-auto text-white/80" size={28} aria-hidden /><h2 className="mx-auto mt-5 max-w-3xl text-balance font-serif text-3xl font-bold text-white sm:text-5xl">{t("final.title")}</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-white/85">{t("final.description")}</p><Link href={authHref} className="app-button app-button-lg mt-8 bg-white text-primary hover:bg-[#f8f5f0]">{t("actions.start")} <ArrowRight size={19} aria-hidden /></Link></div></section>
      </main>
