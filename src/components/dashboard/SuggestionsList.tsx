...
export default function SuggestionsList({ suggestions }: Props) {
  ...
  <Link href="/suggerimenti" className="px-4 py-2 rounded-full text-white inline-flex justify-center text-center min-w-[160px]" style={{ background: 'var(--color-sage)' }}>Apri</Link>
      </div>
