...
export default defineConfig({
  ...
  projects: [
    {
      name: "m8-320",
      grep: /\[M8\]\[(diagnostic|reset|matrix|responsive-320)\]|\[M3\]\[associations-320\]|\[M4\]\[supplier-work-320\]|\[M5\]\[guest-mobile\]/,
      use: { locale: "it", viewport: { width: 320, height: 844 } },
    },
    {
      name: "m8-390",
      grep: /\[M6\]\[security-matrix\]/,
      use: { locale: "it", viewport: { width: 390, height: 844 } },
    },
    {
      name: "m8-430",
      grep: /\[M8\]\[(responsive-430|idea-budget)\]|\[M3\]\[associations-430\]|\[M4\]\[supplier-work-430\]/,
